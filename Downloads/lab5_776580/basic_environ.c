...
int main(int argc, char** argv)
{
  ...
  err = clEnqueueWriteBuffer(command_queue, in_device_object, CL_TRUE, 0, sizeof(float) * count, in, 0, NULL, NULL);
  ...
  // Launch Kernel
  global_size = 128; // ! Si por ejemplo hay 128 work items, y cada work group tiene 32 elementos, habrá 4 work groups
  local_size = 32;
  ...
  // TODO: Check the correctness of the execution
  for(int i = 0; i < count; i++){
    printf("Pow of %d: %f \n", i, out[i]);
  }
